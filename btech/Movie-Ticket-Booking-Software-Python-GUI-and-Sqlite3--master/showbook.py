...
def login():
    ...
    if b:
        ...
        def bookticket():
            ...
            v1=IntVar()
            r=Radiobutton(window,text='Sita Ramam',variable=v1,value=1,bg='light blue')
            r.pack()
            r=Radiobutton(window,text='Super Over',variable=v1,value=2,bg='light blue')
            r.pack()
            r=Radiobutton(window,text='Robo',variable=v1,value=3,bg='light blue')
            r.pack()
            r=Radiobutton(window,text='Sivaji',variable=v1,value=4,bg='light blue')
            r.pack()
            r=Radiobutton(window,text='Boys',variable=v1,value=5,bg='light blue')
            r.pack()
        ...
        def cancel():
            ...
            v2=IntVar()
            r=Radiobutton(window,text='Sita Ramam',variable=v2,value=1,bg='light blue')
            r.pack()
            r1=Radiobutton(window,text='Super Over',variable=v2,value=2,bg='light blue')
            r1.pack()
            r=Radiobutton(window,text='Robo',variable=v2,value=3,bg='light blue')
            r.pack()
            r=Radiobutton(window,text='Sivaji',variable=v2,value=4,bg='light blue')
            r.pack()
            r=Radiobutton(window,text='Boys',variable=v2,value=5,bg='light blue')
            r.pack()
            Label(window,text='enter the date(yyyy-mm-dd)',bg='light blue').pack()
            e=Entry(window)
            e.pack()
